...
|---|---|---|
| `android_compile_sdk` | Compile SDK version (shared) | `35` |
| `android_target_sdk` | Target SDK version (shared) | `35` |
...
| `app_version_code` | App module version code | `36` |
| `app_version_name` | App module version name | `0.5.5` |
